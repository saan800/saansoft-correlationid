...
For api and web projects, registering with the `AddScoped` function is perfect, as it will create a new instance for each http request.
...
However, you can also setup `CorrelationIdProvider` to use values from other sources such as [SaanSoft.CorrelationId.Web](https://github.com/saan800/saansoft-correlationid/blob/main/src/SaanSoft.CorrelationId.Web/README.md) by using other dependencies and middleware.
